...
function EABR.ApplyIconBorder(f, protectedOwner)
    ...
    -- Cropped and masked icons own shape-matched borders. Keep the upstream
    -- rectangular border dormant so it cannot draw across their silhouettes.
    if p and (p.iconShape or "none") ~= "none" then
